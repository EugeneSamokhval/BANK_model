...
std::vector<CardAccount> CheckingDatabase(){
...
std::vector<User> PossibleUsers(){
    std::ifstream Users("UsersList.txt");
    double buffer_cash;
    std::string line;
...
BANK BankInfoReading(std::vector<CardAccount> database){
    std::ifstream Bank("Bank.txt");
...
int main() {
    ...
    AccountsBase = CheckingDatabase();
    UsersBase = PossibleUsers();
    ...
    BANK currentbank = BankInfoReading(AccountsBase);
